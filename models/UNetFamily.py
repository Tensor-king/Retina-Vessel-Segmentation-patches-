...
class Upsample_n_Concat(nn.Module):
    def __init__(self, filters):
        ...
        self.upsample_layer = nn.ConvTranspose2d(filters, filters, kernel_size=4, padding=1, stride=2)
...
class Dense_Unet(nn.Module):
    def __init__(self, in_chan=3, out_chan=2, filters=128, num_conv=4):
        ...
        self.conv1 = nn.Conv2d(in_chan, filters, kernel_size=1)
        ...
        self.outconv = nn.Conv2d(filters, out_chan, kernel_size=1)
