...
if __name__ == "__main__":
    # ------------Path of the dataset --------------------------------
    data_root_path = 'D:\Deep-Learning\deep-learning-for-image-processing-master\Seg-datasets'
    # if not os.path.exists(data_root_path): raise ValueError("data path is not exist, Please make sure your data
    # path is correct") train
    img = "STARE/images"
